package com.uma.southdevelopers.tests;
...
public class Tests {
    ...
    private void checkFields(Enrolment expected, Enrolment actual) {
        assertThat(actual.getEliminada()).isEqualTo(expected.getEliminada());
        assertThat(actual.getNombre()).isEqualTo(expected.getNombre());
        assertThat(actual.getEstudiante()).isEqualTo(expected.getEstudiante());
    }
